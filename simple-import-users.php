<?php
/*
Plugin Name: Simple Import Users (updated by CandleFOREX)
Plugin URI: http://dev.candleforex.com/import-users-updated.zip
Description: Allows blog administrators to add multiple users to blogs at a time, using only a list of email addresses. When the specified email address matches an existing account, the account will be added as a user on the blog. Otherwise a new account is created and the new user added with the specified role. (UPDATED from Boone Gorges' plugin)
Version: 1.2
Requires at least: WordPress 3.0
Tested up to: WordPress 3.4.1
License: GPL v2
Author: CandleFOREX
Author URI: http://www.CandleFOREX.com
Author Blog URI: http://blog.CandleFOREX.com
*/
